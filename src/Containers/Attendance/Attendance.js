...
const Attendance = () => {
  ...
  return (
    <View style={[Layout.fill, ]}>
      {loading && <Loader/>}
      <View style={[Layout.row, Gutters.smallHMargin, Gutters.smallTMargin, { borderRadius: 30, backgroundColor: Colors.light_grey }]}>
        <TouchableOpacity 
          style={[Layout.fill, Layout.center, Gutters.regularVPadding, { backgroundColor: activeIndex == 0 ? Colors.primary : Colors.transparent, borderRadius: 30 }]}
          onPress={() => onSegmentButtonSelected(0)}
        >
          <Text style={[Fonts.titleTiny,{ color: activeIndex == 0 ? Colors.white : Colors.grey }]}>Self</Text>
        </TouchableOpacity>

        <TouchableOpacity 
          style={[Layout.fill, Layout.center, Gutters.regularVPadding, { backgroundColor: activeIndex == 1 ? Colors.primary : Colors.transparent, borderRadius: 30 }]}
          onPress={() => onSegmentButtonSelected(1)}
        >
          <Text style={[Fonts.titleTiny,{ color: activeIndex == 1 ? Colors.white : Colors.grey }]}>Visitor</Text>
        </TouchableOpacity>
      </View>
      ...
      <PagerView style={[Layout.fill]} initialPage={0} ref={ViewPager} onPageSelected={event => onSegmentButtonSelected(event.nativeEvent.position)}>
        <View key={'1'} style={[Layout.fill, Gutters.smallHPadding, Gutters.regularVPadding, Layout.colCenter]}>
          <TouchableOpacity 
            style={[Layout.center, Common.shadow, { width: 100, height: 100, borderRadius: 50, backgroundColor: Colors.primary }]}
            onPress={() => selfAttendance()}
          >
            <Text style={[Fonts.titleTiny,{ color: Colors.white }]}>Tap</Text>
          </TouchableOpacity>

        </View>

        <View key={'2'} style={[Layout.fill, Gutters.smallHPadding, Gutters.regularVPadding]}>
          <View style={{ flex: 1 }}>
            <SelectBox
              ...
              isMulti
              listOptionProps={{ style: { minHeight: height / 2 }, nestedScrollEnabled: true }}
          ...
          <Button mode='contained' color={Colors.primary} style={[Gutters.largeTMargin, Layout.selfCenter, { width: '50%' }]} onPress={() => visitorAttendance()}
          >
            Confirm
          </Button>
        </View>
